...
const SIHInfoDisplay = () => {
    ...
    if (loading) {
        return (
             <Card className="card-hover bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 backdrop-blur-md border-primary/20 overflow-hidden group w-full max-w-4xl mx-auto flex justify-center items-center h-48">
    ...
    return (
        <section aria-labelledby="sih-announcements" className="w-full max-w-4xl mx-auto">
            <Carousel 
                className="w-full"
                ...
                <CarouselContent>
                    {infos.map(info => (
                        <CarouselItem key={info.id}>
                            <Card className="card-hover bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 backdrop-blur-md border-primary/20 overflow-hidden group transition-all duration-300 hover:shadow-lg hover:border-primary/30">
                                <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] lg:aspect-[3/1]">
                                    <Image 
                                        src={info.image_url || `${supabaseUrl}/storage/v1/object/public/media/teambanner2.png`} 
                                        alt={info.title} 
                                        fill
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4 sm:left-6 sm:right-6">
                                        ...
                                        <p className="text-white/80 text-xs sm:text-sm line-clamp-1 mt-1">{info.content}</p>
                                    </div>
                                </div>
                            </Card>
                        </CarouselItem>
